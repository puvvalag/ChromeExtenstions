...
$(document).ready(function(){
  ...
  function getRemote(remote_url) {
   var content = $.ajax({
        type: "GET",
        url: "https://www.nationalgeographic.com/photography/photo-of-the-day/_jcr_content/.syndication-gallery.2019-11.json",
        success: function(data){
          console.log('success');
          alert('success');
          var html = $($.parseHTML(data));
          content = $(data).find('#grid-content').html();
          var rawdata = $(data).find('#grid-content');
          //var containers = content.getElementsByClassName("photogrid-image-container");
          var doc = $(data).html;
          console.log(data);         
      }
    }).responseText;
...
{ 
  ...
  var imageContainters = doc.getElementsByClassName("photogrid-image-container");
  alert(imageContainters);
  console.log(imageContainters);
...
var feedUrl = "https://www.nationalgeographic.com/photography/photo-of-the-day/archive/";
